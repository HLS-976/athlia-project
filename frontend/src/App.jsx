...
function AppContent() {
  ...
  // Exclure la homepage du header global car elle gère son propre header
  const pagesWithoutGlobalHeader = [
    "/dashboard",
    "/combined",
    "/exercises",
    "/skeleton",
  ...
  const shouldShowGlobalHeader = !pagesWithoutGlobalHeader.includes(
    location.pathname
  );
