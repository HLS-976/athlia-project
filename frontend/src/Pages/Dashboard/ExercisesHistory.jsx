        ...
        if (response.ok) {
          ...
          const formattedHistory = data.map((entry) => {
            ...
            if (dateField) {
              ...
              entry.id, "- utilisation de la date actuelle";
            }
    ...
    return (
      <Card
        sx={{
          borderRadius: 3,
          background:
            "linear-gradient(135deg, rgba(16,24,40,0.7) 60%, rgba(59,130,246,0.08) 100%)",
          border: "1.5px solid rgba(59,130,246,0.18)",
          boxShadow:
            "0 8px 32px rgba(16,24,40,0.18), 0 1.5px 8px rgba(59,130,246,0.08)",
          backdropFilter: "blur(8px)",
          WebkitBackdropFilter: "blur(8px)",
          color: "#e2e8f0",
          padding: "32px 24px",
          transition:
            "box-shadow 0.3s cubic-bezier(0.4,0,0.2,1), border-color 0.3s cubic-bezier(0.4,0,0.2,1), transform 0.2s cubic-bezier(0.4,0,0.2,1)",
          position: "relative",
          overflow: "hidden",
          "&:hover": {
            boxShadow:
              "0 12px 40px 0 rgba(59,130,246,0.25), 0 2px 16px rgba(16,185,129,0.12)",
            borderColor: "#3b82f6",
        ...
        {history.length === 0 ? (
          ...
          >
            <p style={{ textAlign: "center", color: "#cbd5e1" }}>
              Aucun exercice enregistré. Commencez par ajouter un exercice !
            </p>
          </Box>
        ) : (
          <TableContainer
            component={Paper}
            sx={{ background: "transparent", boxShadow: "none", flex: 1 }}
          >
            <Table size="small">
              <TableHead>
                <TableRow>
